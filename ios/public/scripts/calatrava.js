    ...
    return {
      after: function(event, handler) {
        ...
        if (priorHandler != null) {
          return handlerRegistry[event] = function() {
            var args;
            args = 1 <= arguments.length ? __slice.call(arguments, 0) : [];
            priorHandler.apply(null, args);
      ...
      bindAll: function(options) {
        ...
        return _.each(options, function(handler, event) {
          return _this.bind(event, handler);
        });
      },
  ...
  calatrava.bridge.plugins = (function() {
    ...
    return {
      ...
      invokeCallback: function(handle, data) {
        return callbacks[handle](data);
      },
      deleteCallback: function(handle) {
